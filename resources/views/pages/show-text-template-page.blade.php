    ...
    <div class="container p-[1.875rem] mx-auto bg-white rounded-[5px] mt-[1.875rem]">
        <form method="post" id="update-text-template" action="#" enctype="multipart/form-data">
            ...
            <div class="form-group mb-4 page-title-main">
                ...
                <textarea class="" name="page_title" id="page_title_editor">{{ isset($show_temp_data->page_title) ? $show_temp_data->page_title : '' }}</textarea>
            </div>

            <div class="form-group mb-4">
                <label for="editor" class="mb-1 block text-sm">Page Description</label>
                <textarea class="mt-1" name="description" id="editor">{{ isset($show_temp_data->description) ? $show_temp_data->description : '' }}</textarea>
            </div>
